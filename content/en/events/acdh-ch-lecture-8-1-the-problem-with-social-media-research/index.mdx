...
image:
  src: >-
    /assets/content/assets/en/events/acdh-ch-lecture-8-1-the-problem-with-social-media-research/image/src.jpg
  caption: ''
startDate: 2022-10-04T16:00:00.000Z
location: Theatersaal, Sonnenfelsgasse 19, 1010 Wien & Online (Zoom)
hosts: []
speakers: []
summary:
  content: >
    ACDH-CH Lecture with Richard Rogers: "The Problem with Social Media
    Research".
links: []
attachments: []
---
...
![](/assets/content/assets/en/events/acdh-ch-lecture-8-1-the-problem-with-social-media-research/rogers-portrait.jpeg)
