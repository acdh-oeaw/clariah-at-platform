...
image:
  src: /assets/content/assets/en/projects/developing-hubert/image/src.png
  caption: ''
summary:
  content: ''
...
links:
  - label: Complexity Science Hub Vienna
    url: https://csh.ac.at/research/research-topic/social-complexity-collapse/
  - label: Seshat Databank
