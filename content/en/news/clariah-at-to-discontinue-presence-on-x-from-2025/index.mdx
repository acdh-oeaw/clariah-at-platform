...
summary:
  content: >-
    CLARIAH-AT decided to discontinue its presence on the social media platform
    X (Twitter) from 2025 onwards and is now present on LinkedIn.
links: []
attachments: []
...
* Subscribe to the Digital Humanities Austria email list: Write an email to [office@clariah.at](mailto:office@clariah.at), indicating 'DHA list subscription' in the subject line
