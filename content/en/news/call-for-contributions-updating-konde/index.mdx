...
image:
  src: >-
    /assets/content/assets/en/news/call-for-contributions-updating-konde/image.png
  caption: ''
summary:
  content: >
    With this call we are looking for contributors to bring in new articles or
    project presentations or to revise existing articles!
links: []
attachments: []
...
of the federally funded Austrian project *Kompetenznetzwerk Digitale Edition* and was published in
...
The aim of the *White Paper* (Weißbuch) was (and is) to provide a low-threshold introduction to the
extensive subject of Digital Editions. The *White Paper* is intended to help users help themselves
...
Despite the large number of contributions, the *White Paper* does not fully cover the complex
...
further explanation and inclusion in the *White Paper on Digital Edition* would be quite useful. It
