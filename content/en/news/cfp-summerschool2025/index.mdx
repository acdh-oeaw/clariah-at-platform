...
image:
  src: /assets/content/assets/en/news/cfp-summerschool2025/image.png
  caption: ''
summary:
  content: >-
    8.-12.9.2025 (Graz): This year's CLARIAH-AT Summer School is aimed at
    students and researchers interested in the interface between digital
    scholarly editing and machine learning. Application is open until 31.3.2025.
links: []
attachments: []
