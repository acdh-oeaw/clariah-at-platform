...
image:
  src: /assets/content/assets/en/news/cfp-clarin-flagship-projects-2025/image.png
  caption: ''
summary:
  content: >-
    The aim of the CLARIN Flagship Project initiative is to improve
    interoperability and facilitate reuse of language resources and tools,
    expand the user base, stimulate cross-lingual, cross-national and
    cross-disciplinary research and demonstrate socioeconomic impact. The call
    provides support for collaborative projects by CLARIN members and observers.
links: []
attachments: []
...
<LinkButton link={{"discriminant":"external","value":"https://www.clarin.eu/content/call-proposals-clarin-flagship-projects-2025"}}>
  CfP CLARIN Flagship Projects 2025
</LinkButton>
