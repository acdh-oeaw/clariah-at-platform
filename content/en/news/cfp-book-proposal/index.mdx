---
title: >-
  CfP - Book Proposal: "Digital Translation History. Processing historical Data
  with new Methodologies"
publicationDate: '2024-04-29'
image:
  src: /assets/content/assets/en/news/cfp-book-proposal/image.png
  caption: ''
summary:
  content: >
    UOC & University of Graz invite proposals for a book publication: Submit
    your abstract of 300 words before June 15th!
links: []
attachments: []
...
The full call for proposals is available <Link link={{ discriminant: "download", value: "/assets/content/downloads/en/news/cfp-book-proposal/book-proposal-digital-translation-history-1-1.pdf" }}>here</Link>.
