...
image:
  src: /assets/content/assets/de/news/summerschool2025-uwk/image.png
  caption: ''
summary:
  content: >-
    Für die Summer School 2025 lädt die Universität für Weiterbildung Krems dazu
    ein, Beiträge aus den Bereichen Kultur-, Konservations-, Archiv- und
    Organisationswissenschaften einzureichen, die sich mit den vielfältigen
    Praktiken des „Aussortierens“ und „Ordnens“ im Sinne der Zugänglich-machung
    von materiellen und immateriellen Sammlungen beschäftigen. 
links: []
attachments: []
...
<DownloadButton label="Additional topics to inspire possible contributions (pdf)" />
...
[helmut.neundlinger@donau-uni.ac.at](mailto:helmut.neundlinger@donau-uni.ac.at)

**Nikolaus Koenig**\
Head of the Center for Applied Game Studies\
[nikolaus.koenig@donau-uni.ac.at](mailto:nikolaus.koenig@donau-uni.ac.at)

in scope GmbH:

**Klaus Neundlinger**\
Head of Research, in scope GmbH\
[klaus.neundlinger@in-scope.com](mailto:klaus.neundlinger@in-scope.com)

For more detailed information, such as submission guidelines and contact details, kindly visit the UWK Website:

<LinkButton link={{"discriminant":"external","value":"https://www.donau-uni.ac.at/de/universitaet/fakultaeten/bildung-kunst-architektur/departments/kunst-kulturwissenschaften/summer-school/summerschool-2025-call.html"}}>
